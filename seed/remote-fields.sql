...
('fld_rec_source', 'col_recipes', 'recipe_source', 'Recipe Source / Attribution', 'string', 'TEXT', 0, 2, 0, 1),
('fld_rec_equip', 'col_recipes', 'equipment', 'Cooking Equipment', 'string', 'TEXT', 0, 3, 0, 1),
('fld_rec_method', 'col_recipes', 'cooking_method', 'Cooking Method', 'string', 'TEXT', 0, 4, 0, 1),
('fld_rec_preptime', 'col_recipes', 'prep_time', 'Prep Time', 'string', 'TEXT', 0, 5, 0, 1),
('fld_rec_cooktime', 'col_recipes', 'cook_time', 'Cook Time', 'string', 'TEXT', 0, 6, 0, 1),
('fld_rec_servings', 'col_recipes', 'servings', 'Yield / Servings', 'string', 'TEXT', 0, 7, 0, 1),
('fld_rec_ingredients', 'col_recipes', 'ingredients', 'Ingredients List', 'text', 'TEXT', 1, 8, 1, 1),
('fld_rec_allergens', 'col_recipes', 'allergens', 'Allergen Disclosures', 'string', 'TEXT', 0, 9, 0, 1),
('fld_rec_content', 'col_recipes', 'content', 'Baking & Cooking Instructions', 'portableText', 'JSON', 0, 10, 1, 1),
('fld_rec_excerpt', 'col_recipes', 'excerpt', 'Summary Excerpt', 'text', 'TEXT', 0, 11, 1, 1),
('fld_rec_notice', 'col_recipes', 'cottage_license_notice', 'Cottage Food Notice', 'string', 'TEXT', 0, 12, 0, 1),
('fld_rec_cardscan', 'col_recipes', 'card_scan_image', 'Uploaded Recipe Card Photo', 'image', 'TEXT', 0, 13, 0, 1);
...
('fld_prod_ingred', 'col_products', 'explicit_ingredients', 'Fallback Ingredients List', 'text', 'TEXT', 0, 7, 0, 1),
